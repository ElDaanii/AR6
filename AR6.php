...
$res = $temperatura / $cont2;

echo "El numero de estaciones que pertenecen al Emisferio Norte son $cont<br>";
echo "El promedio de temperatura en el Emisferio Sur es de $res <br>";
echo "Hay un total de $cont3 temperaturas por debajo de -20 y por encima de 40 grados, y son los siguientes: <br>";
